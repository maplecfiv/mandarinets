...
import { ClientConfig, Client } from "https://deno.land/x/mysql@v2.10.2/mod.ts";
import type { ExecuteResult } from "https://deno.land/x/mysql@v2.10.2/src/connection.ts";
